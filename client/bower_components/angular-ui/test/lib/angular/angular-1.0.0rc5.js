 ...
 *
 * For test we provide {@link angular.module.ngMock.$browser mock implementation} of the `$browser`
 ...
 *
 * In test you can use `$browser.defer.flush()` to flush the queue of deferred functions.
 *
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    Scope.prototype = {
       ...
       * with no `listener`.
       *
       * You may have a need to call `$digest()` from within unit-test, to simulate the scope
       * life-cycle.
       *
       * # Example
         <pre>
