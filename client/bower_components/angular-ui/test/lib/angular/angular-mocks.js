 ...
 *
 * The following apis can be used in test:
 *
...
angular.mock.$ExceptionHandlerProvider = function() {
   ...
   *
   *   - `rethrow`: If any errors are are passed into the handler in test, it typically
 ...
 * If we preserved this behavior in unit testing, we'd have to create async unit test, which are
